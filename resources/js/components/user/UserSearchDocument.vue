          ...
          <div class="modal-body">
            ...
            <form @submit.prevent="performAdvancedSearch">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="documentType" v-model="advancedSearchQuery.documentType">
              </div>
              <div class="form-group">
...
export default {
  ...
  methods: {
    search() {
      axios.post('/api/user/search', { searchQuery: this.searchQuery })
        .then(response => {
    ...
    performAdvancedSearch() {
      axios.post('/api/user/advanced-search', this.advancedSearchQuery)
        .then(response => {
          this.searchResults = response.data;
